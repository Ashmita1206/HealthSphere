        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {result.keyChanges.map((change, idx) => (
              ...
              >
                <div>
                  <span className="font-bold text-slate-900 dark:text-white">{change.metric}</span>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">{change.explanation}</p>
                </div>

                <div className="flex items-center gap-2 font-mono text-[11px]">
                  <span className="text-slate-400 line-through">{change.previousValue}</span>
                  <span>&rarr;</span>
                  <span className="font-bold text-slate-900 dark:text-white">{change.currentValue}</span>
                </div>
