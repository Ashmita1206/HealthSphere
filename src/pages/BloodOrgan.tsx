      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="card-healthcare">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Help save lives by donating blood. Register to be matched with
                those in need.
              </p>
                    ...
                    <div className="space-y-4 mt-4">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(v) =>
                            setDonorForm({ ...donorForm, blood_type: v })
                          }
                        >
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(v) =>
                            setDonorForm({ ...donorForm, willing_to_donate: v })
                          }
                        >
                          <SelectTrigger className="mt-1">
                            <SelectValue />
                      ...
                      {(donorForm.willing_to_donate === 'organ' ||
                        donorForm.willing_to_donate === 'both') && (
                        <div>
          ...
          <Card className="card-healthcare">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Make a difference by pledging to donate organs and give the gift
                of life.
              </p>
              <div className="space-y-2">
                <Button
        ...
        <Card className="card-healthcare mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Submit a request to find available donors
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Dialog
            ...
            >
              ...
              <DialogContent className="max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Submit your request to our donor network
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 mt-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setRequestForm({ ...requestForm, blood_type: v })
                      }
                    >
                      <SelectTrigger className="mt-1">
                        <SelectValue placeholder="Select blood type" />
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setRequestForm({ ...requestForm, urgency: v })
                      }
                    >
                      <SelectTrigger className="mt-1">
                        <SelectValue />
